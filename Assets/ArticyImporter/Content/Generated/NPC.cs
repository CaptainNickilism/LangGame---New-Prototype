...
namespace Articy.Languagegamearticy
{
    ...
    public class NPC : Entity, IEntity, IPropertyProvider, IObjectWithFeatureNPCFeature
    {
        
        [SerializeField()]
        private ArticyValueNPCTemplate mTemplate = new ArticyValueNPCTemplate();
        
        private static Articy.Languagegamearticy.Templates.NPCTemplateConstraint mConstraints = new Articy.Languagegamearticy.Templates.NPCTemplateConstraint();
        
        public Articy.Languagegamearticy.Templates.NPCTemplate Template
        {
            get
            {
        ...
        public static Articy.Languagegamearticy.Templates.NPCTemplateConstraint Constraints
        {
            get
            {
                return mConstraints;
        ...
        public NPCFeatureFeature GetFeatureNPCFeature()
        {
            return Template.NPCFeature;
        }
        ...
        protected override void CloneProperties(object aClone, Articy.Unity.ArticyObject aFirstClassParent)
        {
            ...
            if ((Template != null))
            {
                newClone.Template = ((Articy.Languagegamearticy.Templates.NPCTemplate)(Template.CloneObject(newClone, aFirstClassParent)));
            }
